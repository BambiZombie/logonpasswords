/*	T6QnmvUn sRYb7 `iCICOxYXMs`
	https://blog.iCICOxYXMs.com
	mEF8gRlDDkUTXDyLrs8Owoh
	Licence : https://gtGwFzmac7si4Tt.org/licenses/by/4.0/
*/
...
typedef struct _RwgV_PROCESS_SIGNATURE_PROTECTION {
	UCHAR SignatureLevel;
	UCHAR SectionSignatureLevel;
	PS_PROTECTION Protection;
} RwgV_PROCESS_SIGNATURE_PROTECTION, *PRwgV_PROCESS_SIGNATURE_PROTECTION;

typedef struct _MIMIDRV_PROCESS_PROTECT_INFORMATION {
	ULONG ProCeSsId;
	RwgV_PROCESS_SIGNATURE_PROTECTION SignatureProtection;
